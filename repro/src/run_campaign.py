...
def main() -> None:
    ...
    steps = [
        ...
        (
            "claim_5_mandatory_falsification_audit",
            [
                python,
                "repro/src/claim5_mandatory_falsification_audit.py",
                "--source-audit",
                ".openresearch/artifacts/claim-5/source_audit.json",
                "--output",
                ".openresearch/artifacts/claim-5/route-4-falsification/raw_results.json",
            ],
        ),
        (
            "claim_5_falsification_independent_checker",
            [
                python,
                "repro/src/claim5_falsification_independent_checker.py",
                "--input",
                ".openresearch/artifacts/claim-5/route-4-falsification/raw_results.json",
                "--output",
                ".openresearch/artifacts/claim-5/route-4-falsification/independent_checker.json",
            ],
        ),
        (
            "cumulative_pytest",
