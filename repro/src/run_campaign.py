...
def main() -> None:
    ...
    steps = [
        ...
        (
            "claim_5_stabilized_appendix_j",
            [
                python,
                "repro/src/claim5_stabilized_appendix_j.py",
                "--predictions",
                ".openresearch/artifacts/claim-5/route-3-stabilized/predictions.csv",
                "--output",
                ".openresearch/artifacts/claim-5/route-3-stabilized/raw_results.json",
            ],
        ),
        (
            "claim_5_stabilized_independent_checker",
            [
                python,
                "repro/src/claim5_stabilized_independent_checker.py",
                "--predictions",
                ".openresearch/artifacts/claim-5/route-3-stabilized/predictions.csv",
                "--results",
                ".openresearch/artifacts/claim-5/route-3-stabilized/raw_results.json",
                "--output",
                ".openresearch/artifacts/claim-5/route-3-stabilized/independent_checker.json",
            ],
        ),
        (
            "cumulative_pytest",
